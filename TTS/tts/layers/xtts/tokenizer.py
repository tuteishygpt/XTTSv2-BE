...
_abbreviations = {
    ...
    "be": [
        (re.compile("\\b%s\\." % x[0], re.IGNORECASE), x[1])
        for x in [
            ("г-ня", "гаспадыня"),  # Гаспадыня
            ("г-р", "гаспадар"),    # Гаспадар
            ("д-р", "доктар"),      # Доктар
            ("праф.", "прафесар"),  # Прафесар
            ("гл.", "глядзі"),      # Глядзі
            ("сп.", "спадар"),      # Спадар
            ("сп-ня", "спадарыня"),  # Спадарыня
            ("ст.", "старонка"),    # Старонка
            ("цв.", "цвёрды"),      # Цвёрды
            ("лг.", "лагер"),       # Лагер
            ("т-ва", "таварыства"),  # Таварыства
            ("н-д", "напрыклад"),   # Напрыклад
            ("арт.", "артыкул"),    # Артыкул
            ("б-р", "бульвар"),     # Бульвар
            ("гр.", "грамадзянін"),  # Грамадзянін
            ("інж.", "інжынер"),    # Інжынер
            ("ак.", "акадэмік"),     # Акадэмік
            ("пп.", "пункт"),        # Пункт
            ("г.", "горад"),         # Горад
            ("вобл.", "вобласць"),   # Вобласць
            ("р-н", "раён"),         # Раён
            ("м-р", "магістр"),      # Магістр
        ]
    ],
